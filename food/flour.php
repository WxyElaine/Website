        ...
        <div class="jumbotron">
            <div id="maincontent">
                ...
                <div class="introtext intro-head">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            大草原面粉有限公司坚信，选择最好的小麦是生产出稳定质量产品的唯一方法。
                ...
                <div class="introtext">
                    ...
                    <p>
                        加拿大最重要的农业区是通常所说的“大草原地区”，即阿尔伯塔、
                        萨斯喀彻温和曼尼托巴三个省，那里的土壤以肥沃的棕壤和黑土为主，保肥性良好，
                        是国家的粮仓。这里冬季严寒，无霜期只有200天左右。
                        这种气候条件适宜于硬粒红春小麦和其他耐寒的麦类作物的生长。
                    </p>
                    <p>
                        加拿大小麦质量控制系统要求：少农药化肥来保证生产出世界最安全的食品，加拿大的小麦都是非转基因小麦。
                    </p>
                    <p>
                        面粉的加工是物理分离过程，公司有完善的标准加工车间和系统化的生产流程。
                        在严格的生产流程和不添加任何添加剂的条件下，确保面粉在生产过程中不流失面粉的营养价值，
                        以保证产品的质量，也保留住原生态的健康营养物质。
                        这是大草原面粉被评为“五星级”面粉的重要原因之一。
                    </p>
                </div>
                <div class="highlight">
                    <h2>产品特点</h2>
                    <ul>
                        <li>
                            犹太洁食认证：</br>
                            大草原面粉获得了犹太洁食认证，此认证保证所有获得该标志的食品
                            其原料和生产过程的治疗、洁净度和纯度。
                        </li>
                        <li>无转基因成分</li>
                        <li>无任何化学添加剂，无漂白剂，调理剂</li>
                        <li>未添加防腐剂</li>
                        <li>
                ...
                <div class="types">
                    ...
                    <div class="product">
                        ...
                        <div>
                            <h3>大草原面粉</h3>
                            <h4>零售 ¥85<span style="padding: 0.5em;"></span>团购 ¥72</h4>
                            <p>规格：2.5Kg</p>
                        </div>
