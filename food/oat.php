            ...
            <div id="maincontent">
                ...
                <div class="introtext intro-head">
                    ...
                    <div>
                        ...
                        <p>
                            该公司30多年来一直致力于创造健康美味的谷物食品，是全球最大的燕麦生产商。
                ...
                <div class="introtext">
                    <p>
                        本产品采用100&#37;纯燕麦片，每一片都保留燕麦的完整三层营养成分（麸皮、胚乳和胚芽），
                        营养价值高，富含膳食纤维、蛋白质、维生素B1、B12和镁、铁等矿物质。
                        美国FDA认证燕麦具有降低胆固醇、平稳血糖等功能的食品。
                    </p>
                </div>
                <div class="highlight">
                    <h2>产品特点</h2>
                    ...
                    <ul>
                        <li>无添加人工色素和香料</li>
                        <li>无糖低脂，高复合碳水化合物，高饮食纤维</li>
                        <li>提供人体所需基本维生素和矿物质成分</li>
                        <li>经常食用燕麦也有非常好的降糖、减肥的功效</li>
                    </ul>
                    <h3>兼具可溶性和不可溶性膳食纤维</h3>
                    <ul>
                        <li>可溶性膳食纤维有效地降低人体中的胆固醇含量</li>
                        <li>经常食用可对心脑血管病起到一定的预防作用</li>
                        <li>不可溶性膳食纤维参与人体体液和血液的循环，亦能加强肠道蠕动，促进人体消化吸收</li>
                    </ul>
                    <h3>富含多种矿物质</h3>
                    <ul>
                        <li>
                            含有丰富的钙，磷，铁，锌等矿物质，是补钙佳品，有预防骨质疏松，促进伤口愈合，
                            防止贫血的 功效，还可以改善血液循环
                        </li>
                    </ul>
                    <h3>合理的不饱和脂肪酸含量</h3>
                    <ul>
                        <li>
                            诺思格燕麦中的脂肪主要以不饱和脂肪酸，亚油酸和亚麻酸的形式存在，
                            主要分布在麦仁中，约为3.44&#37;~9.65&#37;，其中不饱和脂肪酸占80&#37;以上
                        </li>
                        <li>
                ...
                <div class="types">
                    ...
                    <div class="product">
                        ...
                        <div>
                            ...
                            <p>规格：28g x 12包</p><p>成分：100&#37;纯天然燕麦</p>
                        </div>
                    </div>
                </div>
                <div class="tip">
