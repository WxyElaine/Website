...
<html>
    <head>
        <title>意大利斯玛葡萄籽油---加枫福德商贸有限公司</title>
        <meta charset="utf-8">
            ...
            <div id="maincontent">
                ...
                <div class="introtext intro-head">
                    ...
                    <div>
                        ...
                        <p>
                            公司的宗旨是寻找和采购最好的原材料和产品，筛选最好的生产商和制造商，
                ...
                <div class="introtext">
                    ...
                    <p>
                        意大利斯玛葡萄籽油是葡萄种子经由最高级的冷压方式精制而成，
                        呈漂亮而自然的淡黄色或淡色，是基础油中相当受欢迎且效果卓着的品种之一。
                    </p>
                    <p>
                        葡萄籽最为称道的是含有两种重要的元素，即亚麻油酸和原花色素，其中
                        亚麻油酸是人体必需而又为人体所不能合成的脂肪酸，具有抵抗自由基、
                        抗老化、强化循环系统的弹性等功效，而原花色素具有保护血管弹性、
                        阻止胆固醇囤积在血管壁上等功效。但因产量少，所以极为珍贵。
                    </p>
                </div>
                <div class="highlight">
                    <h2>产品特点</h2>
                    <p style="text-indent: 2em">葡萄籽油美味又营养，是真正安全健康的基础食用油。</p>
                    <h3>突出特点</h3>
                    <ul>
                        <li>高温加热也不会产生有害物质，不产生油烟，它的高温发烟点可达252&#x2103</li>
                        <li>
                            葡萄籽坚硬厚实的外壳，形成了对农药的天然屏障，能有效的避免葡萄籽油里农药的残留，
                            可以说葡萄籽油是真正安全的食用油
                        </li>
                        <li>
                ...
                <div class="types">
                    ...
                    <div class="product">
                        ...
                        <div>
                            ...
                            <h4>零售 ¥145<span style="padding: 0.5em;"></span>团购 ¥105</h4>
                            <p>规格：750ml</p>
                        </div>
                        <img class="product-img" src="/food/oil/2.jpg" alt="葡萄籽油图片">
                        <div>
                            <h3>意大利斯玛<br class="break">葡萄籽油</h3>
                            <h4>零售 ¥165<span style="padding: 0.5em;"></span>团购 ¥124</h4>
                            <p>规格：1L</p>
                        </div>
                        <img class="product-img" src="/food/oil/3.jpg" alt="葡萄籽油图片">
                        <div>
                            <h3>意大利斯玛<br class="break">葡萄籽油</h3>
                            <h4>零售 ¥415<span style="padding: 0.5em;"></span>团购 ¥363</h4>
                            <p>规格：3L</p>
                        </div>
                    </div>
                </div>
                <div class="tip">
                    ...
                    <ul>
                        ...
                        <li>
                            <b>海鲜烹饪</b></br>
                            用葡萄籽油烹饪海鱼可以去除腥味，保持海鱼原有的鲜味。
                        </li>
                        <li>
                            <b>凉拌</b></br>
                            制作色拉、凉拌蔬菜，可以充分保持蔬菜原有的风味，使菜肴清香可口。
                        </li>
                        <li>
                            <b>配制调和油</b></br>
